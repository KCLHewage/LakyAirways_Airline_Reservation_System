...
public class Admin_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_userlogin.setBackground(new java.awt.Color(59, 52, 134));
        btn_userlogin.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        btn_userlogin.setForeground(new java.awt.Color(252, 253, 242));
        btn_userlogin.setText("User Login");
        btn_userlogin.setFocusPainted(false);
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btn_userlogin, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(19, 19, 19))
        );
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        ...
        if (name.isEmpty())  {
            JOptionPane.showMessageDialog(null,"Username Cannot be Empty", "submision",JOptionPane.INFORMATION_MESSAGE); 
        }
        else if(password.isEmpty()) {
             JOptionPane.showMessageDialog(null,"Password Cannot be Empty", "submision",JOptionPane.INFORMATION_MESSAGE); 
        }
        else  {
            ...
            try  {
               ...
               ResultSet result = st.executeQuery("SELECT Username,Password,FirstName,AdminID FROM admin WHERE Username='"+name+"' AND Password='"+password+"'");
                
               while(result.next()) {
                if (name.equals(result.getString(1)) && password.equals(result.getString(2))) {
                     isLogin=1;
                     Admin_Dashboard admin_dashboard=new Admin_Dashboard();
                     admin_dashboard.setName(result.getString(3));
                     admin_dashboard.setID(result.getString(4));
