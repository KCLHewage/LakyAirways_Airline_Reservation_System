...
public class Update_Users extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_dashboard1.setText("UPDATE USERS");
        ...
        FirstNameText2.setText("UserID");

        txt_uid.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txt_uid, javax.swing.GroupLayout.PREFERRED_SIZE, 262, javax.swing.GroupLayout.PREFERRED_SIZE))))
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(FirstNameText2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txt_uid, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(FirstNameText1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btn_backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_backActionPerformed
        ...
        Update_Users.this.setVisible(false);
    ...
    private void btn_confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_confirmActionPerformed
        String uid, fname,lname,gender,dob,address,tp,username,password;
        dob=null;
        ...
        if(fname.isEmpty()) {
            ...
            try  {
                ...
                int row_count = st.executeUpdate("UPDATE user SET Username='"+username+"', Password='"+password+"', FirstName='"+fname+"', LastName='"+lname+"', DOB='"+dob+"', Gender='"+gender+"', Address='"+address+"', MobileNo='"+tp+"' WHERE UserID='"+uid+"'");
                if (row_count>0)  {
                    JOptionPane.showMessageDialog(null,"Successfully Updated", "Users",JOptionPane.INFORMATION_MESSAGE);
                    Admin_Users admin_users=new Admin_Users();
                    Update_Users.this.setVisible(false);
                    admin_users.setName(name);
                    admin_users.setID(id);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Update_Users().setVisible(true);
            }
        });
    }
