...
public class Add_Flights extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_dashboard1.setText("ADD FLIGHTS");
    ...
    private void btn_backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_backActionPerformed
        ...
        Add_Flights.this.setVisible(false);
    ...
    private void btn_confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_confirmActionPerformed
        ...
        if(fname.isEmpty()) {
            ...
            try  {
                ...
                int row_count = st.executeUpdate("INSERT INTO flight (FlightID, FlightName, FlightCapacity) VALUES ('"+totalCount+"','"+fname+"','48')");
                 if (row_count>0)  {
                     int count = st.executeUpdate("INSERT INTO flightSchedule VALUES ('"+sloc+"','"+eloc+"','"+ddate+"','"+dtime+"','"+adate+"','"+atime+"','"+gate+"','"+totalCount+"')");
                     if (count>0)  {
                    JOptionPane.showMessageDialog(null,"Successfully Added", "Signup",JOptionPane.INFORMATION_MESSAGE);
