...
public class Delete_Users extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_dashboard1.setText("DELETE USERS");
    ...
    private void btn_confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_confirmActionPerformed
        ...
        if(uid.isEmpty()) {
            ...
            try  {
                ...
                int row_count = st.executeUpdate("DELETE FROM user WHERE UserID='"+uid+"'");
                if (row_count>0)  {
                    JOptionPane.showMessageDialog(null,"Successfully Deleted", "Users",JOptionPane.INFORMATION_MESSAGE);
                    Admin_Users admin_users=new Admin_Users();
                    Delete_Users.this.setVisible(false);
